    ...
    <div className="bg-white rounded-3xl p-6 border border-slate-200/90 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 text-xs font-bold px-3 py-1.5 rounded-xl border border-emerald-200 transition-colors"
        >
      ...
      <div className="space-y-4">
        {/* Factor 1: Weekday */}
        <div className="p-4 bg-slate-100 rounded-2xl border border-slate-300/70 flex items-center justify-between">
          ...
          <span className="text-xs font-mono font-bold text-slate-800 bg-white px-2.5 py-1 rounded-lg border border-slate-300">
            0.95x
          </span>
        </div>
        ...
        <div className="p-4 bg-amber-50/60 rounded-2xl border border-amber-200/70 flex flex-col gap-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono font-bold text-amber-900 bg-white px-2.5 py-1 rounded-lg border border-amber-200">
        ...
        <div className="p-4 bg-emerald-50/60 rounded-2xl border border-emerald-200/70 flex items-center justify-between">
          <div className="flex items-center gap-3">
      ...
      <div className="mt-6 p-4 bg-slate-900 text-white rounded-2xl text-xs font-mono">

  ...
  return (
    <PortalLayout>
      <div className="space-y-6 max-w-7xl mx-auto pb-12">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs px-4 py-2 rounded-xl transition-all shadow-md shadow-emerald-700/20"
            >
        ...
        <div className="bg-gradient-to-r from-emerald-900 to-teal-950 text-white rounded-3xl p-6 sm:p-8 shadow-xl border border-emerald-800 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <div className="text-3xl sm:text-4xl font-extrabold text-white">
              {forecast.predictedDemand} <span className="text-xl font-normal text-emerald-200">expected meals</span>
            </div>
          ...
          <div className="flex items-center gap-6 shrink-0 bg-emerald-950/60 p-4 rounded-2xl border border-emerald-800/80">

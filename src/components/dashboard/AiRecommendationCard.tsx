...
export default function AiRecommendationCard() {
  ...
  return (
    <div className="bg-gradient-to-br from-emerald-950 via-slate-900 to-emerald-900 text-white rounded-3xl p-6 lg:p-7 shadow-2xl border-2 border-emerald-600/80 relative overflow-hidden ring-1 ring-emerald-500/30">
      ...
      <div className="relative z-10">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-amber-400/20 text-amber-300 flex items-center justify-center border border-amber-400/40 shadow-inner">
              <Sparkles className="w-6 h-6 animate-pulse" />
            </div>
            <div>
              <div className="text-xs font-extrabold uppercase tracking-widest text-amber-300 flex items-center gap-1.5">
                <span>AI Recommendation Engine</span>
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping inline-block" />
              </div>
              <h3 className="text-xl font-extrabold text-white tracking-tight">Daily Preparation Target Guidance</h3>
            </div>
          </div>
        ...
        {/* Proposal & Action Bar */}
        <div className="bg-emerald-900/70 p-5 rounded-2xl border border-emerald-600/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-5">
          <div>
            ...
            <div className="text-base font-extrabold text-white mt-1">
              ...
              <span className="text-amber-300 text-lg font-black underline decoration-amber-400/50">{forecast.recommendedPrep} meals</span>
            </div>
          ...
          {recommendationAccepted ? (
            <div className="bg-emerald-700 text-white font-bold text-sm px-6 py-3.5 rounded-xl flex items-center gap-2 shadow-inner border border-emerald-400">
            ...
            <button
              ...
              className="w-full sm:w-auto bg-amber-400 hover:bg-amber-300 text-emerald-950 font-black text-sm px-7 py-3.5 rounded-xl transition-all shadow-lg shadow-amber-400/30 hover:scale-[1.02] flex items-center justify-center gap-2 whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-amber-300 focus:ring-offset-2 focus:ring-offset-emerald-950"
            >
